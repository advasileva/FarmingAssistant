...
2. [**Описание доменной области**](#описание-доменной-области)  
...
4. [**Функциональные и нефункциональные требования**](#функциональные-и-нефункциональные-требования)  
