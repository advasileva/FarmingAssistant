...
4. [**Первоначальная архитектура**](#первоначальная-архитектура)  
 4.1. [*Компоненты*](#компоненты)  
 4.2. [*Client*](#client)  
 4.3. [*Server*](#server)  
 4.4. [*Data Base*](#data-base)  
 4.5. [*AI module*](#ai-module)  
 4.6. [*Референсные архитектуры*](#референсные-архитектуры)  
 4.7. [*Docker*](#docker)  
5. [**Итоговая архитектура**](#первоначальная-архитектура)  
 5.1. [*Компоненты*](#компоненты)  
 5.2. [*Client*](#client)  
 5.3. [*Server*](#server)  
 5.4. [*Data Base*](#data-base)  
 5.5. [*AI module*](#ai-module)  
 5.6. [*Референсные архитектуры*](#референсные-архитектуры)  
 5.7. [*Docker*](#docker)    
