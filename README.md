...
10. Сбор данных о погоде с нескольких источников со свободным доступом 

11. Анализ нейронной сетью данных о погоде с нескольких источников и получение индивидуального прогноза погоды для каждого пользователя. 

12. Составление рекомендаций по срокам посадки и сбора (полива и обработки удобрениями) для выбранного поля 

13. Подключение клиента к серверу 

14. Постанализ прогноза погоды в независимых источниках 

15. Получение обратной реакции от пользователя 

16. Сохранение последних полученных рекомендаций для ответов на запросы пользователя без доступа в интернет. 

17. Установка приложения выполняется только при соответствии устройства минимальным системным требованиям и наличии необходимого объема свободной памяти. 
...
19. Интерфейс как мобильного приложения интуитивно понятен и не требует ознакомления с документацией  

20. Система не должна завершаться аварийно при любых действиях пользователя. 

21. Все исходные файлы должны быть документированы. 

22. Полная конфиденциальность. Отсутствие доступа к данным аккаунтов для третьих лиц. 

23. Поддержка только русского языка 

24. Данные о погоде предоставляться в объёме более 1 тысячи одновременных запросов без снижения производительности с загрузкой пользователю не более 3 секунд.      
